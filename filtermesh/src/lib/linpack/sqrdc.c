/* sqrdc.f -- translated by f2c (version of 8 February 1991  13:22:30).
...
/* Computing 2nd power */
	    r__1 = qraux[j] / work[j];
	    tt = tt * (double).05 * (r__1 * r__1) + (double)1.;
