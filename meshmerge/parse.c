...
{
      14,     0,    -1,    -1,    15,    16,    18,    16,    18,    -1,
      17,    -1,    16,    17,    -1,     5,    20,    21,    21,    21,
      -1,    19,    -1,    18,    19,    -1,     6,    20,    20,    20,
      20,    -1,     4,    -1,     4,    -1,     3,    -1
};
...
{
       0,    83,    83,    83,   117,   118,   121,   167,   168,   171,
     207,   213,   214
};
#endif
...
static const char *const yytname[] =
{
  ...
  "'='", "'+'", "'-'", "'*'", "'/'", "UNARYMINUS", "$accept",
  "mesh_format", "@1", "vertex_list", "vertex", "face_list", "face",
  "int_arg", "num_arg", 0
};
#endif
...
{
       2,     0,     0,     1,     0,     0,     4,    10,     0,     0,
       5,     0,     7,    12,    11,     0,     0,     0,     8,     0,
       0,     3,     6,     0,     9
};
...
{
     -14,    10,     7,   -14,    12,    -2,   -14,   -14,     5,    12,
     -14,    -2,   -14,   -14,   -14,     5,    12,    -2,   -14,     5,
      12,    11,   -14,    12,   -14
};
...
{
      16,    10,    19,     4,     9,    18,    22,    20,    13,    14,
       3,    23,     4,    10,    24,    18,     7,     9,    21,    17
};

static const yytype_uint8 yycheck[] =
{
       9,     5,    15,     5,     6,    11,    19,    16,     3,     4,
       0,    20,     5,    17,    23,    21,     4,     6,    17,    11
};
...
{
       0,    14,    15,     0,     5,    16,    17,     4,    20,     6,
      17,    18,    19,     3,     4,    21,    20,    16,    19,    21,
      20,    18,    21,    20,    20
};
...
#line 122 "parse.y"
  ...
  if (parse_seq==0) {
    ...
    vecp->x=(yyvsp[(3) - (5)].dbl)+translate.x;
    vecp->y=(yyvsp[(4) - (5)].dbl)+translate.y;
    vecp->z=(yyvsp[(5) - (5)].dbl)+translate.z;
  }
...
#line 172 "parse.y"
  ...
  if (parse_seq==0) {
    ...
    vert_1=(yyvsp[(3) - (5)].dbl)+max_vertex;
    vert_2=(yyvsp[(4) - (5)].dbl)+max_vertex;
    vert_3=(yyvsp[(5) - (5)].dbl)+max_vertex;
  }
