...
#endif
/* Tokens.  */
#define DIMENSION 258
#define EDGE_SEGMENTS 259
#define MESH3D 260
#define POINTS 261
#define SURFACE_ELEMENTS 262
#define VOLUME_ELEMENTS 263
#define NEWLINE 264
#define REAL 265
#define INTEGER 266
...
{
       0,     0,     3,     4,    11,    13,    16,    23,    29,    31,
      34,    47,    53,    54,    57,    65,    71,    73,    76,    79,
      81,    84,    90,    92,    95,   100,   102,   104
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      19,     0,    -1,    -1,    20,    22,    23,    26,    29,    33,
      -1,     9,    -1,    21,     9,    -1,     5,    21,     3,    21,
      36,    21,    -1,     7,    21,    36,    21,    24,    -1,    25,
      -1,    24,    25,    -1,    36,    36,    36,    36,    36,    36,
      36,    36,    36,    36,    36,    21,    -1,     8,    21,    36,
      21,    27,    -1,    -1,    27,    28,    -1,    36,    36,    36,
      36,    36,    36,    21,    -1,     4,    21,    36,    21,    30,
      -1,    31,    -1,    30,    31,    -1,    32,    21,    -1,    37,
      -1,    32,    37,    -1,     6,    21,    36,    21,    34,    -1,
      35,    -1,    34,    35,    -1,    37,    37,    37,    21,    -1,
      11,    -1,    11,    -1,    10,    -1
};
...
{
       0,    75,    75,    75,   128,   129,   132,   137,   142,   143,
     146,   176,   181,   182,   185,   216,   221,   222,   226,   229,
     230,   233,   238,   239,   242,   271,   277,   278
};
#endif
...
{
  "$end", "error", "$undefined", "DIMENSION", "EDGE_SEGMENTS", "MESH3D",
  "POINTS", "SURFACE_ELEMENTS", "VOLUME_ELEMENTS", "NEWLINE", "REAL",
  "INTEGER", "'='", "'+'", "'-'", "'*'", "'/'", "UNARYMINUS", "$accept",
  ...
  "num_arg_list", "points_block", "point_list", "point", "int_arg",
  "num_arg", 0
};
#endif
...
static const yytype_uint8 yydefact[] =
{
       ...
       0,     0,     0,     0,     0,     0,     3,     6,     7,     8,
       0,    12,     0,     0,     9,     0,    11,     0,     0,     0,
      13,     0,    27,    26,    15,    16,     0,    19,     0,     0,
       0,    17,    18,    20,    21,    22,     0,     0,     0,    23,
...
{
      -1,     1,     2,     7,     5,     9,    28,    29,    14,    36,
      40,    20,    44,    45,    46,    26,    54,    55,    30,    47
};
...
{
     -43,     3,    18,   -43,    20,    28,   -43,    -2,    20,    33,
      20,   -43,    -1,    20,    32,    -1,   -43,    20,    -1,    20,
      36,    20,    -1,    20,    -1,    20,   -43,    35,    37,   -43,
      37,    35,    20,    -1,   -43,    37,    37,    16,    20,    37,
     -43,    37,   -43,   -43,    10,   -43,    22,   -43,    16,    37,
      37,   -43,    35,   -43,    10,   -43,    10,    37,    37,   -43,
      10,    37,    37,    20,    37,    37,    35,    37,    20,    37,
      35,    37,    20,    35
};
...
{
     -43,   -43,   -43,    -8,   -43,   -43,   -43,    19,   -43,   -43,
     -43,   -43,   -43,     2,   -43,   -43,   -43,    -5,     4,   -42
};
...
{
      12,    10,    15,     3,    53,    18,    56,    11,    11,    22,
      16,    24,    56,    27,    60,    31,    17,    33,    63,    21,
      42,    43,    23,     4,    37,    11,    42,    43,    32,     6,
      48,     6,    42,    43,    35,     8,    19,    38,    52,    39,
      41,    13,    25,    49,    11,    50,    51,    34,    16,    59,
       0,     0,     0,    57,    58,    66,     0,     0,     0,     0,
      70,    61,    62,     0,    73,    64,    65,     0,    67,    68,
       0,    69,     0,    71,     0,    72
};

static const yytype_int8 yycheck[] =
{
       8,     3,    10,     0,    46,    13,    48,     9,     9,    17,
      11,    19,    54,    21,    56,    23,    12,    25,    60,    15,
      10,    11,    18,     5,    32,     9,    10,    11,    24,     9,
      38,     9,    10,    11,    30,     7,     4,    33,    46,    35,
      36,     8,     6,    39,     9,    41,    44,    28,    11,    54,
      -1,    -1,    -1,    49,    50,    63,    -1,    -1,    -1,    -1,
      68,    57,    58,    -1,    72,    61,    62,    -1,    64,    65,
      -1,    67,    -1,    69,    -1,    71
};
...
{
       0,    19,    20,     0,     5,    22,     9,    21,     7,    23,
       3,     9,    21,     8,    26,    21,    11,    36,    21,     4,
      29,    36,    21,    36,    21,     6,    33,    21,    24,    25,
      36,    21,    36,    21,    25,    36,    27,    21,    36,    36,
      28,    36,    10,    11,    30,    31,    32,    37,    21,    36,
      36,    31,    21,    37,    34,    35,    37,    36,    36,    35,
      37,    36,    36,    37,    36,    36,    21,    36,    36,    36,
      21,    36,    36,    21
};
...
;}
  ...
  case 25:
#line 271 "netgenparse.y"
    {(yyval.dbl)=(double)ival;;}
    break;

  case 26:
#line 277 "netgenparse.y"
    {(yyval.dbl)=(double)ival;;}
    break;

  case 27:
#line 278 "netgenparse.y"
    {(yyval.dbl)=rval;;}
    break;


/* Line 1267 of yacc.c.  */
#line 1612 "netgenparse.c"
      default: break;
    }
