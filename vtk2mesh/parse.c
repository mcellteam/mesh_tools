...
{
      15,     0,    -1,    -1,    16,    17,    20,    -1,     6,    23,
       5,    18,    -1,    19,    -1,    18,    19,    -1,    24,    24,
      24,    -1,     7,    23,    23,    21,    -1,    22,    -1,    21,
      22,    -1,    23,    23,    23,    23,    -1,     4,    -1,     4,
      -1,     3,    -1
};
...
{
       0,    79,    79,    79,   114,   118,   119,   122,   154,   158,
     159,   162,   192,   198,   199
};
#endif
...
static const char *const yytname[] =
{
  ...
  "POLYGONS", "'='", "'+'", "'-'", "'*'", "'/'", "UNARYMINUS", "$accept",
  "mesh_format", "@1", "vertex_block", "vertex_list", "vertex",
  "face_block", "face_list", "face", "int_arg", "num_arg", 0
};
#endif
...
{
       2,     0,     0,     1,     0,     0,    12,     0,     0,     3,
       0,     0,    14,    13,     4,     5,     0,     0,     6,     0,
       8,     9,     0,     7,    10,     0,     0,    11
};
...
{
     -15,     1,    -3,   -15,     2,     3,   -15,     6,     2,   -15,
       5,     2,   -15,   -15,     5,   -15,     5,     2,   -15,     5,
       2,   -15,     2,   -15,   -15,     2,     2,   -15
};
...
{
       7,     3,    19,     4,    11,    23,     6,    17,    12,    13,
       8,    10,    18,    24,     0,     0,     0,     0,    25,     0,
       0,    26,    27
};

static const yytype_int8 yycheck[] =
{
       4,     0,    16,     6,     8,    19,     4,    11,     3,     4,
       7,     5,    14,    20,    -1,    -1,    -1,    -1,    22,    -1,
      -1,    25,    26
};
...
{
       0,    15,    16,     0,     6,    17,     4,    23,     7,    20,
       5,    23,     3,     4,    18,    19,    24,    23,    19,    24,
      21,    22,    23,    24,    22,    23,    23,    23
};
...
#line 93 "parse.y"
  ...
  while (plp!=NULL) {
    polygon_count++;
    printf("Face %d  %d %d %d\n",polygon_count,
      1+plp->polygon->vertex_index[0],1+plp->polygon->vertex_index[1],
      1+plp->polygon->vertex_index[2]);
    plp=plp->next;
  }
...
char *s;
{
	fprintf(stderr,"vtk2mesh: error on line: %d of file: %s  %s\n",
	        line_num,infile,s);
	fflush(stderr);
	return(1);
}
