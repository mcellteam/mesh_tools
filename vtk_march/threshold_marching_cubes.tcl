...
if {[info exists BLUR_THRESHOLD] == 0} {set BLUR_THRESHOLD 127}
if {[info exists GAUSSIAN_2D_STANDARD_DEVIATION] == 0} {set GAUSSIAN_2D_STANDARD_DEVIATION "1 1"}
if {[info exists GAUSSIAN_RADIUS_FACTORS] == 0} {set GAUSSIAN_RADIUS_FACTORS "1 1 1"}
if {[info exists GAUSSIAN_2D_RADIUS_FACTORS] == 0} {set GAUSSIAN_2D_RADIUS_FACTORS "1 1"}
...
vtkImageGaussianSmooth imageGaussian
    eval imageGaussian SetStandardDeviations $GAUSSIAN_STANDARD_DEVIATION
    eval imageGaussian SetRadiusFactors $GAUSSIAN_RADIUS_FACTORS
    imageGaussian SetInput [$lastConnection GetOutput]
    set lastConnection imageGaussian

vtkImageThreshold thresholdTissue
    thresholdTissue ThresholdBetween $BLUR_THRESHOLD 255
    thresholdTissue SetInValue 255
    thresholdTissue SetOutValue 0
    thresholdTissue SetInput [$lastConnection GetOutput]
    set lastConnection thresholdTissue
