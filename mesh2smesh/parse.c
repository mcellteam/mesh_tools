...
{
      14,     0,    -1,    -1,    -1,    15,    17,    16,    19,    -1,
      18,    -1,    17,    18,    -1,     5,    21,    22,    22,    22,
      -1,    20,    -1,    19,    20,    -1,     6,    21,    21,    21,
      21,    -1,     6,    21,    21,    21,    21,    21,    -1,     4,
      -1,     4,    -1,     3,    -1
};
...
{
       0,    81,    81,    95,    81,   144,   145,   148,   180,   181,
     184,   214,   247,   253,   254
};
#endif
...
static const char *const yytname[] =
{
  ...
  "'='", "'+'", "'-'", "'*'", "'/'", "UNARYMINUS", "$accept",
  "mesh_format", "@1", "@2", "vertex_list", "vertex", "face_list", "face",
  "int_arg", "num_arg", 0
};
#endif
...
{
       2,     0,     0,     1,     0,     3,     5,    12,     0,     0,
       6,    14,    13,     0,     0,     4,     8,     0,     0,     9,
       7,     0,     0,    10,    11
};
...
{
     -15,     6,     5,   -15,     7,     5,   -15,   -15,    -1,     8,
     -15,   -15,   -15,    -1,     7,     8,   -15,    -1,     7,   -15,
     -15,     7,     7,     7,   -15
};
...
{
      18,    17,    11,    12,    21,    20,     3,    22,    23,    24,
       4,     7,    19,     0,    14,    10
};

static const yytype_int8 yycheck[] =
{
      14,    13,     3,     4,    18,    17,     0,    21,    22,    23,
       5,     4,    15,    -1,     6,     5
};
...
{
       0,    14,    15,     0,     5,    17,    18,     4,    21,    16,
      18,     3,     4,    22,     6,    19,    20,    22,    21,    20,
      22,    21,    21,    21,    21
};
...
#line 108 "parse.y"
  ...
  printf("#   n nodes, 3 dimensions, 0 attributes, 0 marks \n");
  printf("%d 3 0 0\n\n",vertex_count);
  vlp=vertex_head;
  while (vlp!=NULL) {
...
#line 215 "parse.y"
    {
  vert_1=(yyvsp[(3) - (6)].dbl);
  vert_2=(yyvsp[(4) - (6)].dbl);
  vert_3=(yyvsp[(5) - (6)].dbl);
  vert_4=(yyvsp[(6) - (6)].dbl);
  polygon_count++;
...
char *s;
{
	fprintf(stderr,"mesh2smesh: error on line: %d of file: %s  %s\n",
