...
python ../transform_traces.py -a mito10_backchecked.amod -s G3-SA_modeled_cropped_1464_alignem_project.json -r rev_transforms.json -y -28 -o out_mito10_backchecked.amod
EC=$?
if [[ "$EC" != "0" ]]; then
