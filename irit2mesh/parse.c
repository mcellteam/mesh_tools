...
{
       0,     0,     3,     5,     8,     9,    17,    18,    22,    27,
      29,    32,    36,    40,    42,    44,    45,    51,    52,    57,
      65,    67,    70,    74,    79,    86,    90
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      27,     0,    -1,    28,    -1,    27,    28,    -1,    -1,    24,
       8,    30,    10,    29,    31,    25,    -1,    -1,    24,    10,
      25,    -1,    24,    10,    33,    25,    -1,    32,    -1,    31,
      32,    -1,    24,    34,    25,    -1,    24,    36,    25,    -1,
      11,    -1,    12,    -1,    -1,    14,    38,    33,    35,    39,
      -1,    -1,    14,    33,    37,    39,    -1,    24,    15,    33,
      33,    33,    33,    25,    -1,    40,    -1,    39,    40,    -1,
      24,    42,    25,    -1,    24,    41,    42,    25,    -1,    24,
      16,    33,    33,    33,    25,    -1,    33,    33,    33,    -1,
      24,    17,    25,    33,    33,    33,    -1
};
...
{
       0,    75,    75,    76,    81,    80,   153,   154,   155,   159,
     160,   164,   165,   169,   170,   175,   174,   209,   208,   242,
     246,   247,   251,   295,   341,   345,   375
};
#endif
...
{
  "$end", "error", "$undefined", "BSPLINE", "COLOR", "KV", "P3", "E3",
  "OBJECT", "SURFACE", "VAR", "INTEGER", "REAL", "A_STRING", "POLYGON",
  "PLANE", "NORMAL", "INTERNAL", "'='", "'+'", "'-'", "'*'", "'/'",
  "UNARYMINUS", "'['", "']'", "$accept", "irit_format", "object", "@1",
  "attribute", "polyhedron", "polygon", "num_arg", "polygon_w_plane", "@2",
  "polygon_wo_plane", "@3", "plane", "vert_list", "vert_spec", "normal",
  "vert", 0
};
#endif
...
{
       0,    26,    27,    27,    29,    28,    30,    30,    30,    31,
      31,    32,    32,    33,    33,    35,    34,    37,    36,    38,
...
{
       0,     0,     0,     2,     6,     1,     3,     0,     0,     0,
       4,    13,    14,     7,     0,     0,     8,     0,     0,     9,
       0,     0,     0,     5,    10,     0,    17,     0,    11,    12,
       0,     0,    15,     0,     0,    18,    20,     0,     0,     0,
       0,     0,     0,    21,    16,     0,     0,     0,     0,     0,
       0,    22,     0,     0,     0,    25,    23,    19,     0,     0,
       0,     0,    24,    26
};
...
{
      -1,     2,     3,    15,     8,    18,    19,    40,    21,    37,
      22,    31,    27,    35,    36,    41,    42
};
...
{
     -22,    -3,     1,   -23,   -16,   -23,   -23,    10,    20,    -8,
     -23,   -23,   -23,   -23,   -13,    11,   -23,    24,     3,   -23,
      -5,    15,    16,   -23,   -23,    27,   -23,     4,   -23,   -23,
       4,    19,   -23,     4,    -2,    19,   -23,    19,     4,    17,
       4,     2,    21,   -23,    19,     4,     4,    22,     4,    31,
      26,   -23,    28,     4,     4,   -23,   -23,   -23,     4,     4,
      29,     4,   -23,   -23
};
...
{
     -23,   -23,    53,   -23,   -23,   -23,    38,    -9,   -23,   -23,
     -23,   -23,   -23,    23,   -12,   -23,    18
};
...
{
      14,     5,     1,    11,    12,     4,    11,    12,     7,    11,
      12,    26,    16,    11,    12,    11,    12,    13,    32,    25,
       9,    33,    39,    43,    38,     1,    49,    17,    23,    45,
      10,    48,    43,    46,    47,    17,    52,    53,    20,    55,
      28,    29,    30,    34,    58,    59,    51,    54,    47,    60,
      61,    56,    63,    57,    62,     6,    24,     0,     0,    50,
      44
};

static const yytype_int8 yycheck[] =
{
       9,     0,    24,    11,    12,     8,    11,    12,    24,    11,
      12,    20,    25,    11,    12,    11,    12,    25,    27,    24,
      10,    30,    24,    35,    33,    24,    24,    24,    25,    38,
      10,    40,    44,    16,    17,    24,    45,    46,    14,    48,
      25,    25,    15,    24,    53,    54,    25,    25,    17,    58,
      59,    25,    61,    25,    25,     2,    18,    -1,    -1,    41,
      37
};
...
{
       0,    24,    27,    28,     8,     0,    28,    24,    30,    10,
      10,    11,    12,    25,    33,    29,    25,    24,    31,    32,
      14,    34,    36,    25,    32,    24,    33,    38,    25,    25,
      15,    37,    33,    33,    24,    39,    40,    35,    33,    24,
      33,    41,    42,    40,    39,    33,    16,    17,    33,    24,
      42,    25,    33,    33,    25,    33,    25,    25,    33,    33,
      33,    33,    25,    33
};
...
#line 346 "parse.y"
    ...
    vecp->x=(yyvsp[(1) - (3)].dbl);
    vecp->y=(yyvsp[(2) - (3)].dbl);
    vecp->z=(yyvsp[(3) - (3)].dbl);
    if (vecp->x < php->llf.x) {
      php->llf.x=vecp->x;
    }
    if (vecp->y < php->llf.y) {
...
#line 376 "parse.y"
    ...
    vecp->x=(yyvsp[(4) - (6)].dbl);
    vecp->y=(yyvsp[(5) - (6)].dbl);
    vecp->z=(yyvsp[(6) - (6)].dbl);
    if (vecp->x < php->llf.x) {
      php->llf.x=vecp->x;
    }
    if (vecp->y < php->llf.y) {
