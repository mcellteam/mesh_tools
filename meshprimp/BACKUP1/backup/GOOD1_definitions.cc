...
class PolygonClass {
	public:
		...
		void checkEdgeEdgeIntersection(double*[3],int[3][2]
										,double*[3],int,int,bool,bool&);
		void checkPolygonEdgePolygonIntersection(double*[3],int[3][2],
												double[3],double*[3],int,int,bool&);
...
class VertexClass {
	public:
		...
		int* neighborhood_vertices_index;
		int next_neighbor_vertex;
		int max_neighborhood_vertices_index;
...
///////////
		...
		void searchForSelfIntersection(ContainerClass&,PolygonClass*,SpaceClass&);
        void checkPolygonPolygonIntersections(ContainerClass&,PolygonClass*, int,int*,int);
