...
// set to true to print #define info to stdout
...
bool append_iteration_number = false;
...
// array sizes
#define NUMBER_OF_INPUT_FILES			610
#define SIZE_OF_OBJECT_NAME				256
#define NUMBER_OF_OBJECTS				610

#define NUMBER_OF_ADJACENT_POLYGONS		15
#define INCREMENT_OF_ADJACENT_POLYGONS	10

#define NUMBER_OF_EDGES_VERTICES		25
#define INCREMENT_OF_EDGES_VERTICES		5

#define NUMBER_OF_ADJACENT_VERTICES		25
#define INCREMENT_OF_ADJACENT_VERTICES	6

#define NUMBER_OF_POLYGONS_IN_BOXES		7
#define INCREMENT_OF_POLYGONS_IN_BOXES	7

#define NUMBER_OF_NEIGHBORS				3
#define INCREMENT_OF_NEIGHBORS			1
...
#define NUMBER_LIST 					60
#define INCREMENT_OF_LIST 				60
...
#define SEARCH_RADIUS  30 // nm

// energy function parameters
#define TARGET_SEPARATION		20.0   // nm
#define SEPARATION_WEIGHT		10.0  // nN/nm
#define EDGE_STRETCH_WEIGHT 	1.0  // nN/nm
#define ANGLE_STRETCH_WEIGHT 	20.0  // nN
#define INTERSECTION_WEIGHT 	20.0  // nN
#define TIME_STEP				0.003 // s
...
// neighborhood vertices hash table size
#define HASH_TABLE_SIZE			64

// watch all vertices of the following object
#define WATCH_OBJECT			40

// restrict watched vertices to the following
#define WATCH_VERTICES			((i==59314)||(i==92506)||(i==59321)||(i==59311))
...
//#define INPUT_DATA_DIR    "/tmp/data/filtered_meshes/"
//#define INPUT_DATA_DIR    "/spin/cnl/mcell/justin/mesh_data/single_synapse/staging/temp/"
#define OUTPUT_DATA_DIR    "/spin/cnl/mcell/justin/mesh_data/single_synapse/primped_meshes/"
//#define OUTPUT_DATA_DIR    "/tmp/data/primped_meshes/"
