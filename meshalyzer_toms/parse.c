...
{
      14,     0,    -1,    -1,    -1,    15,    19,    16,    21,    -1,
       4,    -1,     4,    -1,     3,    -1,    20,    -1,    19,    20,
      -1,     5,    17,    18,    18,    18,    -1,    22,    -1,    21,
      22,    -1,     6,    17,    17,    17,    17,    -1
};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint8 yyrline[] =
{
       0,    81,    81,   135,    81,   157,   165,   166,   170,   171,
     175,   236,   237,   241
};
#endif
...
static const char *const yytname[] =
{
  ...
  "'='", "'+'", "'-'", "'*'", "'/'", "UNARYMINUS", "$accept",
  "mesh_format", "@1", "@2", "int_arg", "num_arg", "vertex_list", "vertex",
  "face_list", "face", 0
};
#endif
...
{
      18,    17,    11,    12,    21,    20,     3,    22,    23,     4,
      10,     7,    19,     0,    14
};

static const yytype_int8 yycheck[] =
{
      14,    13,     3,     4,    18,    17,     0,    21,    22,     5,
       5,     4,    15,    -1,     6
};
...
{
       0,    14,    15,     0,     5,    19,    20,     4,    17,    16,
      20,     3,     4,    18,     6,    21,    22,    18,    17,    22,
      18,    17,    17,    17
};
...
#line 242 "parse.y"
  ...
  pop->polygon_index=(yyvsp[(2) - (5)].dbl);
  pop->area=0.0;
  pop->n_verts=3;
  ...
  pop->vertex_array[0]=smp->vertex_array[(int)(yyvsp[(3) - (5)].dbl)-1];
  pop->vertex_array[1]=smp->vertex_array[(int)(yyvsp[(4) - (5)].dbl)-1];
  pop->vertex_array[2]=smp->vertex_array[(int)(yyvsp[(5) - (5)].dbl)-1];
