                              ...
                              vec_op & all_crossed_objects) const
{
  ...
  //DEBUG
//  if (v->isMatch(37594,"MFB02"))
//  {
//    cout << "\n\nNice::getCrossedObjects: # crossed_objects = "
//          << crossed_objects.size() << endl << endl;
//  }
  //DEBUG
...
//  {
//    cout.precision(12);
//    cout << "\nNice::getCrossedObjects: # all_crossed_objects = "
//          << all_crossed_objects.size() << endl;
//    cout << "\nNice::getCrossedObjects: "
//          << "extra_point ["
//          << extra_object_pt.p[0] << " "
//          << extra_object_pt.p[1] << " "
//          << extra_object_pt.p[2] << "]"
                                          ...
                                          vec_op & crossed_objects) const
{
  ...
  // DEBUG
//  if (distinguishable(extra_obj_pt.p[0],4587.7666667)==false &&
//      distinguishable(extra_obj_pt.p[1],7446.73004563)==false &&
//      distinguishable(extra_obj_pt.p[2],9352.56321607)==false)
//  {
//    for (fp_it i=fg.crossed_faces.begin();i!=fg.crossed_faces.end();i++)
//    {
//      cout << "Nice::getCrossedObjFromExtraToLimit: crossed face\n";
//      (*i)->print(std::cout);
//    }
//   
//  }
...
//  exit(1);
  ...
  {
//    // DEBUG
//    if (distinguishable(end.p[0],4587.7666667)==false &&
//        distinguishable(end.p[1],7446.73004563)==false &&
//        distinguishable(end.p[2],22705.3882366)==false)
//    {
//      cout << "\n\nNice::findIntFacesAlongRay: face was processed.\n";
//      (*j)->print(std::cout);
//    }
//    // DEBUG
//    //DEBUG
//    if ((*j)->isMatch(246466,"MFB02"))
//    {
//      cout << "\n\nNice::findIntFacesAlongRay: mystery face was processed.\n";
//    }
//    //DEBUG
    (*j)->clearFlag();
