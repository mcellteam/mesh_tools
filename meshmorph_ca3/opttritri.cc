...
int NoDivTriTriIsect(vector3 const * V0,vector3 const * V1,vector3 const * V2,
                     vector3 const * U0,vector3 const * U1,vector3 const * U2,bool target_flag)
{
...
//  if (target_flag==true)
//  {
//    printf("NoDivTriTriIsect: projections onto L:\n");
...
//  if (target_flag==true)
//  {
//    printf("NoDivTriTriIsect: intervals:\n");
//    std::cout.precision(12);
//    std::cout << "\ntmp = " << tmp
//              << ", x0 = " << x0
//              << ", x1 = " << x1
...
//  if (target_flag==true)
//  {
//    printf("NoDivTriTriIsect: target faces were found to intersect.\n");
//    std::cout.precision(12);
//    V0->print(std::cout);
//    std::cout << std::endl;
//    V1->print(std::cout);
...
int tri_tri_intersect(vector3 const * V0,vector3 const * V1,vector3 const * V2,
                      vector3 const * U0,vector3 const * U1,vector3 const * U2,bool target_flag)
{
  Controls & cs(Controls::instance());
  double d1,d2;
  ...
  /* coplanarity robustness check */
#if USE_EPSILON_TEST==TRUE
  if(FABS(du0)<cs.get_epsilon()) du0=0.0;
  if(FABS(du1)<cs.get_epsilon()) du1=0.0;
  if(FABS(du2)<cs.get_epsilon()) du2=0.0;
#endif
  du0du1=du0*du1;
  du0du2=du0*du2;
...
#if USE_EPSILON_TEST==TRUE
  if(FABS(dv0)<cs.get_epsilon()) dv0=0.0;
  if(FABS(dv1)<cs.get_epsilon()) dv1=0.0;
  if(FABS(dv2)<cs.get_epsilon()) dv2=0.0;
#endif
  ...
  /* compute interval for triangle 1 */
  int select[2];
  COMPUTE_INTERVALS(vp0,vp1,vp2,dv0,dv1,dv2,dv0dv1,dv0dv2,isect1[0],isect1[1],select[0]);

  /* compute interval for triangle 2 */
  COMPUTE_INTERVALS(up0,up1,up2,du0,du1,du2,du0du1,du0du2,isect2[0],isect2[1],select[1]);
...
//  if (target_flag==true)
//  {
//    printf("tri_tri_intersect: intervals:\n");
//    std::cout.precision(12);
//    std::cout      << "isect1 [ "
//          << isect1[0] << " "
//          << isect1[1]<< "], isect2 [ "
...
//  if (target_flag==true)
//  {
//    printf("tri_tri_intersect: target faces were found to intersect.\n");
//    std::cout.precision(12);
//    std::cout << "\n\n"
//              << "du0 = " << du0
//              << ", du1 = " << du1
                        ...
                        result & r)
{
  ...
  if( ((d_origin > cs.get_epsilon()) && (d_end > cs.get_epsilon())) ||
      ((d_origin < cs.get_epsilon()) && (d_end < cs.get_epsilon())) )
    return 0;
  ...
  if (fabs(u)<cs.get_epsilon() || fabs(v)<cs.get_epsilon() ||
