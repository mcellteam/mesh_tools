...
#define COMPUTE_INTERVALS(VV0,VV1,VV2,D0,D1,D2,D0D1,D0D2,isect0,isect1,select) \
  if(D0D1>0.0f)                                         \
  {                                                     \
    /* here we know that D0D2<=0.0 */                   \
    /* that is D0, D1 are on the same side, D2 on the other or on the plane */ \
    /*if (target_flag) printf("1111111111111\n");*/         \
    select = 1;                                         \
  ...
  {                                                     \
    ...
    /*if (target_flag) printf("2222222222222\n");*/         \
    select = 2;                                         \
  ...
  {                                                     \
    ...
    /*if (target_flag) printf("3333333333333\n");*/         \
    select = 3;                                         \
    ISECT(VV0,VV1,VV2,D0,D1,D2,isect0,isect1);          \
  }                                                     \
  else if(D1!=0.0f)                                     \
  {                                                     \
    /*if (target_flag) printf("4444444444444\n");*/         \
    select = 4;                                         \
    ISECT(VV1,VV0,VV2,D1,D0,D2,isect0,isect1);          \
  }                                                     \
  else if(D2!=0.0f)                                     \
  {                                                     \
    /*if (target_flag) printf("5555555555555\n");*/         \
    select = 5;                                         \
    ISECT(VV2,VV0,VV1,D2,D0,D1,isect0,isect1);          \
  }                                                     \
  else                                                  \
  {                                                     \
    ...
    /*if (target_flag) printf("6666666666666\n");*/         \
    select = 6;                                         \
...
int tri_tri_intersect(vector3 const * V0,vector3 const * V1,vector3 const * V2,
                      vector3 const * U0,vector3 const * U1,vector3 const * U2,bool);
