...
#define FLOAT 260
#define POINTS 261
#define POINT_DATA 262
#define POLYGONS 263
#define NORMALS 264
#define NORMALS_LOWER 265
...
{
       0,     0,     3,     4,     5,    11,    16,    18,    21,    25,
      30,    32,    35,    40,    41,    48,    50,    53,    57,    59,
      61
};
...
{
      18,     0,    -1,    -1,    -1,    19,    21,    24,    20,    27,
      -1,     6,    30,     5,    22,    -1,    23,    -1,    22,    23,
      -1,    31,    31,    31,    -1,     8,    30,    30,    25,    -1,
      26,    -1,    25,    26,    -1,    30,    30,    30,    30,    -1,
      -1,     7,    30,     9,    10,     5,    28,    -1,    29,    -1,
      28,    29,    -1,    31,    31,    31,    -1,     4,    -1,     4,
      -1,     3,    -1
};
...
{
       0,    82,    82,    97,    82,   154,   158,   159,   162,   194,
     198,   199,   202,   232,   233,   238,   239,   242,   259,   265,
     266
};
#endif
...
{
  "$end", "error", "$undefined", "REAL", "INTEGER", "FLOAT", "POINTS",
  "POINT_DATA", "POLYGONS", "NORMALS", "NORMALS_LOWER", "'='", "'+'",
  "'-'", "'*'", "'/'", "UNARYMINUS", "$accept", "mesh_format", "@1", "@2",
  "vertex_block", "vertex_list", "vertex", "face_block", "face_list",
  "face", "normals_block", "normals_list", "normal", "int_arg", "num_arg", 0
};
#endif
...
{
       2,     0,     0,     1,     0,     0,    18,     0,     0,     3,
       0,     0,    13,    20,    19,     5,     6,     0,     0,     0,
       4,     7,     0,     9,    10,     0,     0,     8,    11,     0,
...
{
     -18,     3,    -1,   -18,     4,     1,   -18,     5,     4,   -18,
      -2,     4,     6,   -18,   -18,    -2,   -18,    -2,     4,     4,
     -18,   -18,    -2,     4,   -18,     4,     7,   -18,   -18,     4,
       2,     4,     9,   -18,    -2,    -2,   -18,    -2,   -18,    -2,
     -18
};
...
{
       7,    13,    14,     3,    11,     4,    22,    18,     6,     8,
      10,    27,    32,    19,    34,    26,    30,    28,    38,     0,
       0,    29,     0,    37,    37,    31,    39,    33,    40,    21
};

static const yytype_int8 yycheck[] =
{
       4,     3,     4,     0,     8,     6,    17,    11,     4,     8,
       5,    22,    10,     7,     5,    19,     9,    23,    35,    -1,
      -1,    25,    -1,    34,    35,    29,    37,    31,    39,    15
};
...
{
       0,    18,    19,     0,     6,    21,     4,    30,     8,    24,
       5,    30,    20,     3,     4,    22,    23,    31,    30,     7,
      27,    23,    31,    25,    26,    30,    30,    31,    26,    30,
       9,    30,    10,    30,     5,    28,    29,    31,    29,    31,
      31
};
...
#line 203 "parse.y"
    {
  vert_1=(yyvsp[(2) - (4)].dbl);
  vert_2=(yyvsp[(3) - (4)].dbl);
  vert_3=(yyvsp[(4) - (4)].dbl);
  polygon_count++;
