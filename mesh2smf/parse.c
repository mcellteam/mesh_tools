...
{
       0,    79,    79,    92,    79,   121,   122,   125,   157,   158,
     161,   191,   197,   198
};
#endif
...
{
       2,     0,     0,     1,     0,     3,     5,    11,     0,     0,
       6,    13,    12,     0,     0,     4,     8,     0,     0,     9,
       7,     0,     0,    10
};
...
char *s;
{
	fprintf(stderr,"mesh2smf: error on line: %d of file: %s  %s\n",
	        line_num,infile,s);
	fflush(stderr);
	return(1);
}
