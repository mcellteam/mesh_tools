...
#line 242 "parse.y"
  ...
  pop->vertex_array[0]=smp->vertex_array[(int)yyvsp[-2].dbl-1];
  pop->vertex_array[1]=smp->vertex_array[(int)yyvsp[-1].dbl-1];
  pop->vertex_array[2]=smp->vertex_array[(int)yyvsp[0].dbl-1];
