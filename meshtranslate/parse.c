...
{
      14,     0,    -1,    -1,    15,    16,    18,    -1,    17,    -1,
      16,    17,    -1,     5,    20,    21,    21,    21,    -1,    19,
      -1,    18,    19,    -1,     6,    20,    20,    20,    20,    -1,
       4,    -1,     4,    -1,     3,    -1
};
...
{
       0,    82,    82,    82,   114,   115,   118,   150,   151,   154,
     183,   189,   190
};
#endif
...
{
     -15,     8,     4,   -15,     7,    -3,   -15,   -15,     2,     7,
     -15,     9,   -15,   -15,   -15,     2,     7,   -15,     2,     7,
     -15,     7,   -15
};
...
{
      16,    18,     4,     9,    20,    13,    14,    19,     3,     4,
      21,     7,    22,     0,    17,     9,    10
};

static const yytype_int8 yycheck[] =
{
       9,    15,     5,     6,    18,     3,     4,    16,     0,     5,
      19,     4,    21,    -1,    11,     6,     5
};
...
char *s;
{
	fprintf(stderr,"meshtranslate: error on line: %d of file: %s  %s\n",
