...
const bool WRITE_NONNICE_VERTICES_TO_FILE = true;
...
const bool WRITE_NEIGHBORHOOD_TO_FILE = false;
...
const bool APPEND_ITERATION_NUMBER_TO_MESH = false;
...
const bool APPEND_ITERATION_NUMBER_TO_DISTANCES = false;
...
const bool DETECT_COMPLETE_SEPARATION = true;
...
const bool MOVE_NONNICE_AND_INTERSECTED_FIRST = false;
...
//  equivalent to a 30 degree sweep around normal
//  i.e. a 60 degree window around normal
#define CLOSEST_POINT_COSINE	0.8660
...
const double INTERSECTION_WEIGHT  = 0.1;  // nN
const double EDGE_STRETCH_WEIGHT  = 9.9;  // nN/nm
...
//
// morph1 and morph2 = > #define TIME_STEP				0.3 // s
#define TIME_STEP				1.0 // s
#define DAMPING					1.0	 // nN/(nm/s)

double SEPARATION_GAIN = 10;

//double ANGLE_GAIN = 5; 
double ANGLE_GAIN = 10;
const int ANGLE_EXPONENT = 1;

double STRETCH_GAIN = 40;
// morph1 and morph2 = >double STRETCH_GAIN = 10;
const int STRETCH_EXPONENT = 1;

const double ASPECT_RATIO_THRESHOLD = 3.0;
const double ASPECT_SCALE = 3;
...
const double MAX_ACTUAL_DISPL_FRACTION	=	0.1;

// maximum allowed runtime in seconds
#define MAX_RUNTIME  561600  // 6.5 days

const bool ENABLE_VTRACK = false;

const bool DISABLE_GAIN_SCHEDULING = false;

const int VECTOR_RESERVE = 1000;
