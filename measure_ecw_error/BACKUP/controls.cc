...
// total world volume used to compute
// extracellular volume fraction
#define WORLD_VOLUME 6000.0*6000.0*6000.0 // nm^3

// desired surface density for ecw sampling
// =area of equilateral triangle of length 20 nm
// =20*10*sin(60)
double ECW_SAMPLING_AREA = 173.21; // nm^2
...
#define EDGE_STRETCH_WEIGHT 	 9.9  // nN/nm
#define SEPARATION_WEIGHT	10.0  // nN/nm
#define ANGLE_STRETCH_WEIGHT 	80.0  // nN
...
double TARGET_SEPARATION = 20;   // nm
