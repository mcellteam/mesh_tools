...
static const yytype_int8 yyrhs[] =
{
      ...
      18,    -1,    19,    -1,    20,    -1,     7,    -1,    -1,    22,
      21,    24,    -1,    23,    -1,    22,    23,    -1,     5,    26,
      27,    27,    27,    -1,    25,    -1,    24,    25,    -1,     6,
      26,    26,    26,    26,    -1,     4,    -1,     4,    -1,     3,
      -1
};
...
{
       0,    84,    84,    84,   126,   127,   130,   131,   134,   142,
     141,   179,   180,   183,   225,   226,   229,   265,   271,   272
};
#endif
...
{
  "$end", "error", "$undefined", "REAL", "INTEGER", "VERTEX", "FACE",
  "COMMENT", "'='", "'+'", "'-'", "'*'", "'/'", "UNARYMINUS", "$accept",
  "mesh_format", "@1", "statement_list", "statement", "comment",
  "vertex_face_block", "@2", "vertex_list", "vertex", "face_list", "face",
  "int_arg", "num_arg", 0
};
#endif
...
{
       0,    14,    16,    15,    17,    17,    18,    18,    19,    21,
      20,    22,    22,    23,    24,    24,    25,    26,    27,    27
};
...
{
       2,     0,     0,     1,     0,     8,     3,     4,     6,     7,
       9,    11,    17,     0,     5,     0,    12,    19,    18,     0,
       0,    10,    14,     0,     0,    15,    13,     0,     0,    16
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     1,     2,     6,     7,     8,     9,    15,    10,    11,
      21,    22,    13,    19
};
...
{
     -21,     6,     4,   -21,     8,   -21,     4,   -21,   -21,   -21,
       5,   -21,   -21,    -1,   -21,     7,   -21,   -21,   -21,    -1,
       8,     7,   -21,    -1,     8,   -21,   -21,     8,     8,   -21
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -21,   -21,   -21,   -21,     9,   -21,   -21,   -21,   -21,    10,
     -21,    -7,   -20,   -18
};
...
{
      24,    23,    17,    18,    27,    26,     3,    28,    29,     4,
       4,     5,    12,    20,    25,    14,     0,     0,     0,     0,
      16
};

static const yytype_int8 yycheck[] =
{
      20,    19,     3,     4,    24,    23,     0,    27,    28,     5,
       5,     7,     4,     6,    21,     6,    -1,    -1,    -1,    -1,
      10
};
...
{
       0,    15,    16,     0,     5,     7,    17,    18,    19,    20,
      22,    23,     4,    26,    18,    21,    23,     3,     4,    27,
       6,    24,    25,    27,    26,    25,    27,    26,    26,    26
};
...
#line 184 "parse.y"
  ...
  vertex_index=(yyvsp[(2) - (5)].dbl);
  if (vertex_index>max_vertex) {
    max_vertex=vertex_index;
  }
  vecp->x=(yyvsp[(3) - (5)].dbl);
  vecp->y=(yyvsp[(4) - (5)].dbl);
  vecp->z=(yyvsp[(5) - (5)].dbl);
...
#line 230 "parse.y"
    {
  polygon_index=(yyvsp[(2) - (5)].dbl);
  vert_0=(yyvsp[(3) - (5)].dbl);
  vert_1=(yyvsp[(4) - (5)].dbl);
  vert_2=(yyvsp[(5) - (5)].dbl);
...
char *s;
{
	fprintf(stderr,"meshclip: error on line: %d of file: %s  %s\n",
	        line_num,infile,s);
	fflush(stderr);
	return(1);
}
