...
{
       0,     0,     3,     5,     8,     9,    10,    17,    19,    23,
      24,    26,    28,    31,    36,    41,    43,    45,    46,    47,
      54,    56,    59,    62
};
...
{
      23,     0,    -1,    24,    -1,    23,    24,    -1,    -1,    -1,
       3,    28,    25,    29,    26,    27,    -1,    15,    -1,    12,
      28,    15,    -1,    -1,     4,    -1,    30,    -1,    29,    30,
      -1,     5,    31,    33,    11,    -1,     6,    32,    32,    32,
      -1,    13,    -1,    14,    -1,    -1,    -1,     7,     8,    34,
      36,    35,    10,    -1,    37,    -1,    36,    37,    -1,     9,
      38,    -1,    32,    32,    32,    -1
};
...
{
       0,    81,    81,    82,    87,   141,    86,   164,   168,   175,
     178,   184,   185,   189,   193,   197,   198,   203,   230,   202,
     238,   239,   243,   289
};
#endif
...
{
  "$end", "error", "$undefined", "SOLID", "OBJ_NAME", "FACET", "NORMAL",
  "OUTER", "LOOP", "VERTEX", "ENDLOOP", "ENDFACET", "ENDSOLID", "INTEGER",
  "REAL", "EOF_TOK", "'='", "'+'", "'-'", "'*'", "'/'", "UNARYMINUS",
  "$accept", "stl_format", "solid_def", "@1", "@2", "end_of_stl_file",
  "object_name", "polyhedron", "facet", "normal", "num_arg", "outer_loop",
  "@3", "@4", "vert_list", "vert_spec", "vert", 0
};
#endif
...
{
       0,    22,    23,    23,    25,    26,    24,    27,    27,    28,
      28,    29,    29,    30,    31,    32,    32,    34,    35,    33,
      36,    36,    37,    38
};
...
{
       0,     9,     0,     2,    10,     4,     1,     3,     0,     0,
       5,    11,     0,     0,     0,    12,    15,    16,     0,     0,
       0,     9,     7,     6,     0,    17,    13,     0,    14,     0,
       8,     0,    18,    20,     0,    22,     0,    21,     0,    19,
      23
};
...
{
      -1,     2,     3,     8,    14,    23,     5,    10,    11,    13,
      18,    20,    29,    36,    32,    33,    35
};
...
{
       0,     5,     1,   -19,   -19,   -19,   -19,   -19,     6,     4,
       6,   -19,    -6,     7,   -10,   -19,   -19,   -19,    -6,     9,
       8,     5,   -19,   -19,    -6,   -19,   -19,    -3,   -19,    12,
     -19,    -6,    12,   -19,    -6,   -19,    13,   -19,    -6,   -19,
     -19
};
...
{
     -19,   -19,    16,   -19,   -19,   -19,     3,   -19,    15,   -19,
     -18,   -19,   -19,   -19,   -19,   -17,   -19
};
...
{
      24,     6,    21,     1,     1,    22,    28,    16,    17,     4,
      12,     9,    30,    34,    19,    37,    38,    25,     7,    26,
      40,    31,     0,    39,    27,    15
};

static const yytype_int8 yycheck[] =
{
      18,     0,    12,     3,     3,    15,    24,    13,    14,     4,
       6,     5,    15,    31,     7,    32,    34,     8,     2,    11,
      38,     9,    -1,    10,    21,    10
};
...
{
       0,     3,    23,    24,     4,    28,     0,    24,    25,     5,
      29,    30,     6,    31,    26,    30,    13,    14,    32,     7,
      33,    12,    15,    27,    32,     8,    11,    28,    32,    34,
      15,     9,    36,    37,    32,    38,    35,    37,    32,    10,
      32
};
