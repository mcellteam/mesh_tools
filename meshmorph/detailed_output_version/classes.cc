...
//	std::vector<Vertex*>::iterator detectPunishableVertex(std::vector<Vertex*>::iterator);
...
//std::vector<Vertex*>::iterator Monitor::detectPunishableVertex(std::vector<Vertex*>::iterator i){
//std::vector<Vertex*>::iterator Monitor::detectPunishableVertex(std::vector<Vertex*>::iterator i,bool int_flag,bool ang_flag){
std::vector<Vertex*>::iterator Monitor::detectPunishableVertex(std::vector<Vertex*>::iterator i,bool int_flag,bool ang_flag,VTrack &pod,Container &c){
